...
* @date January, 2018
* @brief This file is for testing our program.
*/
#include <iostream>
#include <string>
	...
	FOREVER
	{
		...
		case 2: // Motion Menu
			...
			FOREVER
			{
				...
				{
					system("cls");
					cout << "Please type numbers between 1-9." << endl << endl;
				}
			}
			break;
		case 3: // Sensor Menu
			...
			FOREVER	
			{
				cout << "Select Sensor: " << endl << "1. Laser Sensor" << endl << "2. Sonar Sensor" << endl << "3. Print position and all sensor values." << endl << "4. Back" << endl << "Choose One: ";
				cin >> sw3;
				if (sw3 == 1)
				{
					system("cls");
